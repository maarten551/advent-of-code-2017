...
namespace Console_Application
{
    public class HexMazeSolver
    {
        ...
        public void AddStep(string step)
        {
            ...
            int amountOfStepsBack = AmountOfStepsBack();
            if (amountOfStepsBack > furthestAway)
                furthestAway = amountOfStepsBack;
        }
        ...
        public int FurthestAway => furthestAway;
    }
}