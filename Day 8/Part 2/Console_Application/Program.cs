...
namespace Console_Application
{
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var highestValueEver = registerHandler.GetHighestRegisterValueWhileProcessing();
            if (highestValueEver.HasValue)
                Console.WriteLine($"Register '{highestValueEver.Value.Item1}' with value: {highestValueEver.Value.Item2}");
        }
